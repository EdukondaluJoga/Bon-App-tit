...
module.exports = {
    ...
    loginUser : async(req, res) => {
        ...
        try {
            ...
            if(!user){
                return res.status(400).json({status: false, message: "This Credentials are not yet Registered"});
            }
            ...
            if(depassword !== req.body.password){
                return res.status(400).json({status: false, message: "Entered wrong Password"}); 
            }
